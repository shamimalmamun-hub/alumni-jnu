      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {activeTab === 'pay' && !createdReceipt && (
          <div className="space-y-6 animate-in fade-in duration-300">
            {/* Zakat Fund Dedicated Visual Poster if Zakat is selected */}
            {purposeType === 'donation_zakat' ? (
              <div className="bg-white border-2 border-emerald-600 rounded-2xl overflow-hidden shadow-lg animate-in zoom-in-95 duration-200">
                <div className="bg-gradient-to-r from-[#004d38] via-[#006a4e] to-[#004d38] text-white py-3 px-4 sm:px-6 flex flex-wrap items-center justify-between gap-3 border-b border-emerald-500/40">
                  <div>
                    <h2 className="text-lg sm:text-2xl font-black font-serif-bn tracking-tight text-white">
                      {language === 'bn' ? 'Zakat (যাকাত তহবিল) - পেমেন্ট সেকশন' : 'Zakat Fund Payment Section'}
                    </h2>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="px-3 py-1 rounded-full text-xs font-black bg-amber-400 text-emerald-950 shadow-xs">
                      {language === 'bn' ? '১০০% শরীয়াহসম্মত যাকাত' : '100% Shariah Compliant'}
                    </span>
                  </div>
                </div>

                {/* Zakat Image Display */}
                <div className="p-3 sm:p-5 bg-gradient-to-b from-[#f4f8f5] to-white flex flex-col items-center justify-center">
                  <div className="relative group max-w-2xl w-full flex justify-center">
                    <img
                      src="/zakat-1.jpeg"
                      alt="Zakat Fund - Botany Alumni Association Jagannath University"
                      className="w-full max-h-[460px] object-contain rounded-xl shadow-md border-2 border-emerald-500/40 bg-white"
                    ...
                    return (
                      ...
                      >
                        <div>
                          ...
                          {/* Image thumbnail for Zakat */}
                          {cat.id === 'donation_zakat' && (
                            <div className="my-1.5 rounded-lg overflow-hidden border border-emerald-400/80 shadow-2xs relative">
                              <img
                                src="/zakat-1.jpeg"
                                alt="Zakat (যাকাত তহবিল)"
                                className="w-full h-24 sm:h-28 object-cover group-hover:scale-105 transition-transform duration-300"
                                referrerPolicy="no-referrer"
                              />
                              <div className="absolute bottom-1 right-1 bg-emerald-950/80 text-amber-300 text-[10px] font-bold px-1.5 py-0.5 rounded backdrop-blur-xs">
                                {language === 'bn' ? 'যাকাত তহবিল' : 'Zakat Fund'}
                              </div>
                            </div>
                          )}
            ...
            <div className="bg-white rounded-2xl p-5 border-2 border-emerald-500 shadow-sm space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-base text-gray-900">
                      {language === 'bn' ? 'যাকাত তহবিল (Zakat Fund)' : 'Zakat Fund'}
                    </h3>
                    <p className="text-xs text-emerald-700 font-semibold">
                      {language === 'bn' ? 'মেধাবী অসচ্ছল শিক্ষার্থী ও বিপদগ্রস্ত অ্যালামনাই কল্যাণ' : 'Needy Students & Alumni Welfare'}
                    </p>
                  </div>
                </div>
                <span className="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-amber-100 text-amber-900 border border-amber-300">
                  {language === 'bn' ? '১০০% শরীয়াহসম্মত' : '100% Shariah'}
                </span>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-4">
                <div className="w-full md:w-1/2 flex justify-center">
                  <img
                    src="/zakat-1.jpeg"
                    alt="Zakat Fund Poster"
                    className="w-full h-auto max-h-56 object-contain rounded-xl border border-emerald-300 shadow-xs bg-emerald-50/30"
                    referrerPolicy="no-referrer"
                  />
                </div>
                <div className="w-full md:w-1/2 space-y-2.5 text-xs">
                  <p className="text-gray-700 leading-relaxed font-medium">
                    {language === 'bn'
                      ? 'উদ্ভিদবিজ্ঞান বিভাগ অ্যালামনাই অ্যাসোসিয়েশনের যাকাত তহবিলের অর্থ সরাসরি অসচ্ছল মেধাবী শিক্ষার্থীদের আর্থিক বৃত্তি এবং অসুস্থ বা বিপদগ্রস্ত অ্যালামনাইদের চিকিৎসায় ব্যয় হয়।'
                      : 'Zakat funds are directly disbursed to underprivileged botany students as education grants and distressed alumni as medical assistance.'}
                  </p>
                  <div className="pt-2">
                    <button
                      type="button"
                      ...
                      className="px-4 py-2 bg-[#006a4e] hover:bg-[#00523d] text-white text-xs font-bold rounded-lg transition-colors cursor-pointer shadow-xs inline-flex items-center gap-1.5"
                    >
                      <Sparkles className="w-3.5 h-3.5 text-amber-300" />
                      <span>{language === 'bn' ? 'যাকাত তহবিলে অনুদান দিন' : 'Donate to Zakat Fund'}</span>
                    </button>
                  </div>
                </div>
              </div>
