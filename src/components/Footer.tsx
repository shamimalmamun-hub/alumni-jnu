  ...
  return (
    <footer id="main-portal-footer" className="w-full bg-[#16221d] text-white text-base border-t-4 border-[#008e48] font-siliguri">
      <div className="w-full h-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-3.5">
            <div className="flex flex-col items-start gap-3">
              ...
              {/* Text underneath */}
              <div>
                <h3 className="font-bold text-lg sm:text-xl text-emerald-300 leading-tight">
                  {language === 'bn' ? 'উদ্ভিদবিজ্ঞান অ্যালামনাই অ্যাসোসিয়েশন' : 'Botany Alumni Association'}
                </h3>
                <p className="text-amber-300 text-sm sm:text-base font-bold mt-1">
          ...
          <div className="space-y-3.5">
            ...
            <div className="space-y-3 text-gray-200 text-sm sm:text-[15px]">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:+8801401996674" className="hover:text-amber-300 transition-colors font-mono font-semibold">
                  +880 1401-996674
                </a>
              </div>
            </div>
        ...
        <div className="bg-[#0b120f] py-4 px-3 sm:px-6 border-t border-emerald-950 text-gray-300 text-xs sm:text-sm">
