...
const FAQ_LIST: FAQItem[] = [
  {
    ...
    answerBn: 'জগন্নাথ বিশ্ববিদ্যালয়ের উদ্ভিদবিজ্ঞান বিভাগ থেকে ডিগ্রি প্রাপ্ত (কলেজ এবং বিশ্ববিদ্যালয়) স্নাতক (সম্মান), স্নাতকোত্তর বা উচ্চতর ডিগ্রিতে উত্তীর্ণ সকল প্রাক্তন শিক্ষার্থী অ্যালামনাই অ্যাসোসিয়েশনের সদস্য হওয়ার যোগ্য।',
    answerEn: 'All former students who obtained degrees (college and university: B.Sc Honours, M.Sc, or higher degrees) from the Department of Botany, Jagannath University are eligible to become members of the Alumni Association.',
    category: 'alumni'
  },
  {
    id: 'faq-2',
...
export const FAQSection: React.FC<FAQSectionProps> = ({ language }) => {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-[#f4faf6] to-[#edf7f0] border border-[#c2e2cc] rounded-2xl p-4 sm:p-8 space-y-5 sm:space-y-6 shadow-sm font-siliguri">
      {/* Header Banner */}
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 sm:gap-4 border-b border-emerald-200/60 pb-4 sm:pb-5">
        <div className="flex items-start sm:items-center gap-3 w-full">
          <div className="p-2 sm:p-3 bg-[#006a4e] text-white rounded-xl sm:rounded-2xl shadow-sm shrink-0 mt-0.5 sm:mt-0">
            <HelpCircle className="w-5 h-5 sm:w-6 sm:h-6" />
          </div>
          <div className="flex-1 min-w-0">
            <h2 className="text-sm sm:text-xl md:text-2xl font-bold text-gray-900 font-serif-bn leading-snug break-words">
