...
const TREASURER_PHOTO_URL = 'https://mssalumni.org/wp-content/uploads/2026/09/WhatsApp-Image-2026-09-08-at-4.55.13-PM.jpeg';
        ...
        <div className="flex gap-3.5 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-1 text-left">
            ...
            <p className="text-[11px] text-gray-600 font-medium leading-tight">
              {language === 'bn' ? TREASURER_BIO.ministryBn : TREASURER_BIO.ministryEn}
            </p>
            ...
            <div className="pt-1 flex flex-col gap-0.5 text-[11px] text-gray-700">
              ...
              >
                ...
                <span className="font-semibold">{TREASURER_BIO.phone}</span>
              </a>
              <a
              ...
              >
                ...
                <span className="truncate">{TREASURER_BIO.email}</span>
              </a>
            </div>
          </div>
        </div>
