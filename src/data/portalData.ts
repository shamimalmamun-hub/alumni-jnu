...
export interface CommitteeMember {
  ...
  email?: string;
  photoUrl?: string;
  roleType?: 'chief' | 'president' | 'secretary' | 'treasurer' | 'joint_secretary' | 'organizing' | 'member' | 'convenor' | 'joint_convenor' | 'member_secretary';
}
...
export const EXECUTIVE_COMMITTEE_LIST: CommitteeMember[] = [
  ...
  {
    id: 'ec-4',
    nameBn: 'সহ-সভাপতিবৃন্দ',
    nameEn: 'Vice Presidents',
    designationBn: 'সহ-সভাপতি (কার্যনির্বাহী পরিষদ)',
    designationEn: 'Vice Presidents (Executive Council)',
    batchBn: 'বিভিন্ন ব্যাচ',
    batchEn: 'Senior Batches',
    roleType: 'member'
  },
  {
    id: 'ec-5',
    nameBn: 'যুগ্ম সাধারণ সম্পাদকবৃন্দ',
    nameEn: 'Joint General Secretaries',
    designationBn: 'যুগ্ম সাধারণ সম্পাদক',
    designationEn: 'Joint General Secretaries',
    batchBn: 'বিভিন্ন ব্যাচ',
    batchEn: 'Respective Batches',
    roleType: 'joint_secretary'
  },
  {
    id: 'ec-6',
    nameBn: 'সাংগঠনিক সম্পাদক ও সম্পাদকীয় সেল',
    nameEn: 'Organizing & Secretarial Cells',
    designationBn: 'সাংগঠনিক ও দপ্তর সম্পাদক',
    designationEn: 'Organizing & Office Secretaries',
    batchBn: 'বিভিন্ন ব্যাচ',
    batchEn: 'Respective Batches',
    roleType: 'organizing'
  }
